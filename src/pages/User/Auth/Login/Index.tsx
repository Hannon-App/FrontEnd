...
const LoginUser = () => {
    ...
    const handleLogin = (e: any) => {
        e.preventDefault();
        axios
            .post("https://hannonapp.site/login", formData)
            .then((response) => {
                ...
                <div className='md:w-1/2 lg:w-1/3 xm:w-1/2'>
                    ...
                    <div className='bg-white rounded-md flex justify-center'>
                        <div className='w-full m-10'>
                            <h1 className='text-center text-3xl font-bold text-gray-900'>Login User</h1>
                            <div className=''>
                                <InputLogin
                                    id="email"
                                    name="email"
                            ...
                            <div className="flex justify-center mt-7">
                                <h2 className='font-medium text-blue-600 hover:underline'><a href="/RegisterUser">or, signup</a></h2>
                            </div>
                        </div>
